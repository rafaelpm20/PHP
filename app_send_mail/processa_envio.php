...
<!-- 
    ...
    try {
        ...
        //Recipients
        $mail->setFrom('rafaelpenadev@gmail.com', 'Web Completo Remente');
        $mail->addAddress($mensagem->__get('para'));     //Add a recipient
        //$mail->addAddress('ellen@example.com');               //Name is optional
        $mail->addReplyTo('rafaelpenadev@gmail.com', 'Web Completo Resposta');
        ...
        $mail->AltBody = 'è necessário um client que suporte HTML para ter acesso total ao conteúdo desta mensagem';
    ...
    } //algum logica que armazene o erro para uma futura analise -->
